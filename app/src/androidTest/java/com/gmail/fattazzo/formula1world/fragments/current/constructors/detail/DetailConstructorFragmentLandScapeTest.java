 ...
 *         date: 20/09/17
 */
public class DetailConstructorFragmentLandScapeTest extends BaseTest {

    @Test
    public void testProgressLandscape() {
        rotateLandscape();
    ...
    private void testSeasonProgress(int season) {
        ...
        for (int i = 0; i <= constructors.size() - 1; i++) {
            ...
            onView(allOf(withId(R.id.swipe_refresh_layout),hasDescendant(withId(R.id.race_result_progress_main_layout)))).perform(swipeDown());
