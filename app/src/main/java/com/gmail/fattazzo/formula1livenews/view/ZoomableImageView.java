package com.gmail.fattazzo.formula1livenews.view;
...
public class ZoomableImageView extends android.support.v7.widget.AppCompatImageView {
     ...
     * @param clipToBitmap Touch event may occur within view, but outside image content. True, to clip return value to the bounds
     *                     of the bitmap size.
