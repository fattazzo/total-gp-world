...
import static com.gmail.fattazzo.formula1world.ergast.config.ErgastConfig.BASE_REQ;
import static com.gmail.fattazzo.formula1world.ergast.config.ErgastConfig.USER_AGENT;
...
class ErgastConnection {
    ...
    private String buildUrl(@NonNull Ergast ergast, @NonNull String request, int round) {
        String url = BASE_REQ.
                ...
                replace("{SEASON}", ergast.getSeason() == CURRENT_SEASON ? "current" : String.valueOf(ergast.getSeason())).
