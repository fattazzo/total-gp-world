...
public class ConstructorsNationalityWinsStatsFragment extends AbstractStatsChartFragment {
    ...
    public List<StatsData> loadData() {
        return statisticsService.loadConstructorsWinsNationality(seasonStart, seasonEnd);
    }
