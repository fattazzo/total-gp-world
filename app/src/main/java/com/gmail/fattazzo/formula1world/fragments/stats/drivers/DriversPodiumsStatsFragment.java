...
public class DriversPodiumsStatsFragment extends AbstractStatsChartFragment {

    @NonNull
    @Override
    public List<StatsData> loadData() {
        return statisticsService.loadDriversPodiums(seasonStart, seasonEnd);
    }
    ...
    protected View getHeaderListView() {
        ...
        ((TextView) header.findViewById(R.id.textLabel)).setText(getString(R.string.drivers));
