...
public class SeasonDriversCircuitsStatsFragment extends AbstractStatsCircuitsFragment {

    @NonNull
    @Override
    protected List<StatsCircuitsData> loadData() {
        return statisticsService.loadCircuitsWinner(seasonStart, StatsCircuitsData.Type.DRIVERS_WINNER);
    }
}
